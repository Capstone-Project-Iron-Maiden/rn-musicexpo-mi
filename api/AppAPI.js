...
export function loadHomeData() {
    firebase.database().ref('/musicexpoDBMI/homescreen').on('value', (snapshot) => {
...
export function loadScheduleData() {
  firebase.database().ref('/musicexpoDBMI/schedulescreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadExhibitorData() {
  firebase.database().ref('/musicexpoDBMI/exhibitorscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadSpeakerData() {
  firebase.database().ref('/musicexpoDBMI/speakerscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadTicketData() {
  firebase.database().ref('/musicexpoDBMI/ticketscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
